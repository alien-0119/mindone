"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/sew/test_modeling_sew.py."""
...
SEW_CASES = [
    ...
    [
        "SEWForCTC",
        "transformers.SEWForCTC",
        "mindone.transformers.SEWForCTC",
        (config,),
        {},
        (input_values, attention_mask),
        {},
