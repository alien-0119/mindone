"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/encodec/test_modeling_encodec.py."""
...
DTYPE_AND_THRESHOLDS = {"fp32": 1e-1, "fp16": 2e-1}
MODES = [1]
...
model_tester = EncodecModelTester()
...
Encodec_CASES = [
    [
        ...
        "mindone.transformers.EncodecModel",
        (config,),
        {},
