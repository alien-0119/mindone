"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/doge/test_modeling_doge.py."""
...
class DogeModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        if self.use_labels:
            ...
            token_labels = ids_numpy([self.batch_size, self.seq_length], self.vocab_size)
...
DOGE_CASES = [
    [
        ...
        "mindone.transformers.DogeModel",
        (config,),
        {},
    ...
    [
        "DogeForCausalLM",
        "transformers.DogeForCausalLM",
        "mindone.transformers.DogeForCausalLM",
        (config,),
        {},
        (inputs_dict["input_ids"], inputs_dict['attention_mask']),
        {},
    ...
    [
        ...
        "transformers.DogeForSequenceClassification",
        "mindone.transformers.DogeForSequenceClassification",
        (config,),
        {},
        (inputs_dict["input_ids"], inputs_dict['attention_mask']),
        {},
