...
class Exaone4RotaryEmbedding(nn.Cell):
...
class Exaone4Attention(nn.Cell):
    def __init__(self, config: Exaone4Config, layer_idx: int):
        ...
        self.q_proj = mint.nn.Linear(self.hidden_size, self.num_attention_heads * self.head_dim, bias=False)
        ...
        self.o_proj = mint.nn.Linear(self.num_attention_heads * self.head_dim, self.hidden_size, bias=False)
