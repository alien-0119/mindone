...
class LoraConfig(PeftConfig):
    ...
    rank_pattern: Optional[dict] = field(
        ...
        metadata={
            "help": (
                "The mapping from layer names or regexp expression to ranks "
                "which are different from the default rank specified by `r`. "
    ...
    alpha_pattern: Optional[dict] = field(
        ...
        metadata={
            "help": (
                ...
                "which are different from the default alpha specified by `lora_alpha`. "
